...
const Activity: React.FC = () => {
  return (
    <div className='flow-root text-left p-5 my-8'>
            ...
            <div className='relative flex items-start space-x-3'>
              ...
              <div className='min-w-0 flex-1 py-0'>
                <div className='text-sm leading-8 text-gray-500'>
                  ...
                  <span className='whitespace-nowrap ms-2'>6h ago</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className='min-w-0 flex-1'>
                ...
                <div className='mt-2 text-sm text-gray-700'>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tincidunt nunc ipsum
                    tempor purus vitae id. Morbi in vestibulum nec varius. Et diam cursus quis sed
                    purus nam. Scelerisque amet elit non sit ut tincidunt condimentum. Nisl ultrices
                    eu venenatis diam.
                  </p>
                </div>
              </div>
